...
export default {
  ...
  plugins: [
    ...
    production &&
      html({
        fileName: 'index.html',
        title: 'TailwindCSS-Svelte-Typescript-Rollup Template.',
        meta: [
          {
            charset: 'utf8',
          },
          ...
          {
            name: 'description',
            content: 'A template to use these technologies in a straightforward manner.',
          },
          { name: 'robots', content: 'index,follow' },
          {
            name: 'keywords',
            content: 'tailwindcss,svelte,typescript,rollup,airbnb,jest',
          },
          {
